...
def store_data(processed_df):
    ...
    processed_df.coalesce(1).write.mode("overwrite").json("gs://com-hemanth-codebase/emp_output")
    #processed_df.write.format("bigquery").option("temporaryGcsBucket","gs://com-hemanth-codebase").save("dataset1.emptable")
...
def main():
    ...
    structempdf = read_data(spark, "gs://com-hemanth-codebase/employee.csv")
